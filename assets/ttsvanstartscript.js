...
const fileNames = ["thema01", "thema02", "thema03", "thema04", "thema05", "thema06", "thema07", "thema08",
  "core01", "core02", "core03", "core04", "core05", "core06", "core07", "core08", "core09", "core10"
];
...
function reloadTable(jsonData) {
  ...
  jsonData.forEach((word, index) => {
    ...
    <td onclick="speakText('${word.dutchsentence?.replace(/'/g, "")}')"><span style="font-size: 0.6em;">/${word.pronunciation?.ipa || ""}/ <br/> /${word.pronunciation?.phonetic || ""}/</span><br/><span> ${word.dutchsentence}</span><br/><span class="hide-text" style="color: #3f3838ff; opacity: 0.3;">${word.englishtranslate}</span></td>
