...
function reloadTable(jsonData) {
  ...
  jsonData.forEach((word, index) => {
    ...
    <td onclick="speakText('${word.dutchsentence}')"><span class="hide-text">${word.dutchsentence}</span><br/><span class="hide-text" style="color: #ccc; opacity: 0.6;">${word.englishtranslate}</span></td>
