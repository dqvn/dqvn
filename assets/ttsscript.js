...
const fileNames = ["ch01", "ch03", "ch02", "ch04", "ch05", "ch06", "ch07", "ch08", "ch09", "ch10", "ch11", "ch12", "ch13", "ch14", "ch15", "ch16", "ch17", "ch18",
  "sp02", "sp03", "sp04", "sp05", "sp06", "sp07", "sp08", "sp09", "sp10", "sp11", "sp12", "sp13", "sp14", "sp15", "sp16", "sp17", "sp18",
...
function reloadTable(jsonData) {
  ...
  jsonData.forEach((word, index) => {
    ...
    row.innerHTML = `
    <td>${index + 1}</td>
    <td onclick="speakText('${word.dutch?.replace(/'/g, "")}')"><span class="dutch-word" data-index="${index}">${word.dutch}</span><br/><span style="font-size: 0.8em;">/${word.pronunciation?.ipa || ""}/ ~ /${word.pronunciation?.phonetic || ""}/</span></td>
