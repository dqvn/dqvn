...
Thì quá khứ đơn (imperfect) dùng để:

### **1.1. Miêu tả các hành động thường xuyên trong quá khứ**

Ví dụ trích từ sách:

*   *“We gingen vroeger vaak naar opa en oma.”* – Chúng tôi thường hay đến thăm ông bà ngày xưa.
*   *“Opa speelde spelletjes, ging wandelen, maakte muziek.”* – Ông chơi trò chơi, đi dạo, chơi nhạc.    

### **1.2. Tường thuật chuỗi sự kiện nối tiếp nhau trong quá khứ**

Ví dụ:

*   *“Ik kwam gisteren laat thuis. Ik nam een biertje, deed de tv aan, keek nieuws…”*  
    → Tôi về nhà muộn hôm qua, uống bia, bật TV, xem tin tức…    

### **1.3. Văn viết dùng thì quá khứ nhiều hơn văn nói**

Trong hội thoại, người Hà Lan thích dùng **thì hoàn thành hiện tại (VTT)** cho sự kiện đã hoàn thành; còn **thì quá khứ đơn** được dùng chủ yếu trong văn kể, mô tả, truyện.    

***

# 2. **Cấu trúc & Quy tắc chia động từ**

## **2.1. Động từ có quy tắc (weak verbs)**

### Công thức:

*   **Số ít:** stem + **-te** hoặc **-de**
*   **Số nhiều:** stem + **-ten** hoặc **-den**

### Quy tắc chọn **-te / -de**

Dựa trên cụm phụ âm cuối của gốc:

| Kết thúc bằng phụ âm "cứng" | thêm **-te / -ten**         |
| --------------------------- | --------------------------- |
| p, t, k, f, s, ch           | (‘t kofschip / SoFTKeTCHuP) |

| Kết thúc bằng phụ âm “mềm”   | thêm **-de / -den** |
| ---------------------------- | ------------------- |
| m, n, l, r, b, d, g, v, w, z |                     |
...
*   *speelden → speelde / speelden*
*   *werkte, kookte, praatte, zette, legde*    

***

## **2.2. Động từ mạnh (strong verbs) – bất quy tắc**

*   Có sự **đổi nguyên âm ở thân** → quy luật riêng từng nhóm.
*   Hình thức: **đổi nguyên âm + không thêm ge- + -en (số nhiều)**
...
## **2.3. Động từ tách được (separable verbs)**

*   Chia động từ giống quy tắc regular/strong
*   **Phần tiền tố tách rời đứng cuối câu**

📌 Ví dụ trong simple past:
...
## **2.4. Động từ không tách được (inseparable verbs)**

Tiền tố **không tách**: be-, ge-, her-, ont-, ver-  
→ Chia theo dạng thường, không làm thay đổi gì.
...
# 3. **Thì quá khứ của “hebben” & “zijn”**

*   **hebben → had / hadden**
*   **zijn → was / waren**

📌 Dùng nhiều trong văn kể chuyện:
...
# 4. **Động từ khiếm khuyết (modal verbs) trong quá khứ**

Modal verbs chia dạng quá khứ:
...
# 5. **Danh sách động từ bất quy tắc tiêu biểu trong Unit 21**

Trích từ các bài tập và danh mục:

*   *breken → brak*
*   *gaan → ging*
*   *openen → opende* (regular)
*   *stelen → stal*
*   *zien → zag*
*   *werken → werkte*
*   *kampeerden, wandelden, praatten*
*   *aten (ăn), zwommen (bơi), zaten (ngồi)*
*   *nam (lấy), wachtte (đợi), kwam (đến), ging (đi)*    

***

# 6. **Dạng bài tập tiêu biểu của Unit 21**

### **6.1. Nhận diện đuôi -te / -de**

Người học phải xác định gốc động từ kết thúc bằng phụ âm “cứng” hay “mềm”.

### **6.2. Chuyển động từ hiện tại → quá khứ đơn**

Ví dụ gợi ý từ bài tập:

*   *breken, gaan, openen, stelen, zien, zijn, werken*    

### **6.3. Hoàn thành câu chuyện ở thì quá khứ**

Ví dụ có trong tài liệu:

*   *kampeerden, wandelden, praatten, gingen, aten, zwommen, zaten, was, had…*    

### **6.4. Chia modal verbs ở quá khứ**

*   moesten, mochten, kon, wilde, konden    

### **6.5. Luyện hội thoại và kể chuyện**

Động từ như:

*   *bekeek, lag, stond, liet, zag, was, vond, nam, zat, kwam, ging…*    

***

# 7. **Ghi nhớ quan trọng**

### ✔ Thì quá khứ đơn dùng cho **thói quen** hoặc **chuỗi sự kiện** trong quá khứ.

### ✔ Thường dùng trong **văn viết** hơn văn nói.

### ✔ Động từ chia theo **regular – strong – irregular**.
